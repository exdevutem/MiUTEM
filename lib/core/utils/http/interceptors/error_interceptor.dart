...
InterceptorsWrapper errorInterceptor = InterceptorsWrapper(
  onError: (DioException err, ErrorInterceptorHandler handler) {
    ...
    if(json is Map && json.containsKey("error")) {
      return handler.reject(DioException(requestOptions: err.requestOptions, error: CustomException.fromJson(json as Map<String, dynamic>)));
    }
    ...
    final error = DioException(requestOptions: err.requestOptions, error: CustomException.fromJson({
      ...
      "codigoInterno": 0.0,
    }), response: err.response, type: err.type, stackTrace: err.stackTrace);
