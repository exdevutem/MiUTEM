  ...
  group("Asignatura", () {
    ...
    group("colorPorEstado", () {
      test("debería retornar verde para Aprobado", () {
        ...
        expect((asignatura.colorPorEstado.g * 255.0).round().clamp(0, 255), greaterThan(200));
      });
      ...
      test("debería retornar rojo para Reprobado", () {
        ...
        expect((asignatura.colorPorEstado.r * 255.0).round().clamp(0, 255), greaterThan(200));
      });
      ...
      test("debería retornar azul para otros estados", () {
        ...
        expect((asignatura.colorPorEstado.b * 255.0).round().clamp(0, 255), greaterThan(200));
      });
    });
